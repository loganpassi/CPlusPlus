...
int main( )
{
	...
	cout << "Carwash time is 4 minutes." << endl;
	cout << "Simulation of arrival every 6.7 minutes for a total of 100 minutes." << endl;
    car_wash_simulate(240, 1.0/400, 6000);
	cout << "Carwash time is 3 minutes." << endl;
	car_wash_simulate(180, 1.0 / 400, 6000);
