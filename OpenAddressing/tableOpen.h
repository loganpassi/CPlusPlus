// FILE: tableOpen.h
// TEMPLATE CLASS PROVIDED: tableOpen<RecordType> (a table of records with keys).
...
// 
// MEMBER CONSTANT for the tableOpen<RecordType> class:
//   static const size_type CAPACITY = ________
//     tableOpen<RecordType>::CAPACITY is the maximum number of records held by a table.
//
// CONSTRUCTOR for the tableOpen<RecordType> template class:
//   tableOpen( )
//     Postcondition: The table has been initialized as an empty table.
//
// MODIFICATION MEMBER FUNCTIONS for the tableOpen<RecordType> class:
...
//
// CONSTANT MEMBER FUNCTIONS for the tableOpen<RecordType> class:
...
//      table.
//
//  VALUE SEMANTICS for the tableOpen<RecordType> template class:
...
#include "tableOpen_template.h" // Include the implementation.
#endif
