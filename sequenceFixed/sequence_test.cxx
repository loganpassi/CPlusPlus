// FILE: sequenceFixed_test.cxx
// An interactive test program for the new sequenceFixed class
...
#include "sequenceFixed.h"  // With value_type defined as double
using namespace std;
...
void show_sequence(sequenceFixed display);
...
int main( )
{
    sequenceFixed test; // A sequenceFixed that we’ll perform tests on
